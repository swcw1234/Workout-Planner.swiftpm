...
struct File: View {
    @State var exercies: [String]  = ["PUSHUPS", "SQUATS","LUNGES","BENCH PRESSES","PULLUPS", "LATERAL RAISES", "DEADLIFTS", "HAMMER CURLS", "JUMMPING JACKS", "DUMBELL ROWS", "OVERHEAD PRESS", "BENT OVER ROWS","CURL UPS","CABLE CROSSOVERS"]
