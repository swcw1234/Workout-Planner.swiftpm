...
struct File: View {
    @State var exercies: [String]  = ["CABLE WOODCHOPPER","PUSHUPS", "SQUATS","LUNGES","BENCH PRESSES","PULLUPS", "LATERAL RAISES", "DEADLIFTS", "HAMMER CURLS", "JUMMPING JACKS", "DUMBELL ROWS", "OVERHEAD PRESS", "BENT OVER ROWS","CURL UPS","CABLE CROSSOVERS","INCLINE BENCH PRESS","TRICEPS DUMBBELL EXTENSIONS","FACE PULL","LEG PRESSE", "TRICEP PUSHDOWNS","WIDEPLANE DUMBBELL ROWS","SEATED LEG CURLS","HIP THRUSTES","GLUTE BRIDGES","HANGING LEG RAISES","HYPEREXTENSIONS"]
    
    @State var listOfExercises: [String] = ["CABLE WOODCHOPPER","PUSHUPS", "SQUATS","LUNGES","BENCH PRESSES","PULLUPS", "LATERAL RAISES", "DEADLIFTS", "HAMMER CURLS", "JUMMPING JACKS", "DUMBELL ROWS", "OVERHEAD PRESS", "BENT OVER ROWS","CURL UPS","CABLE CROSSOVERS","INCLINE BENCH PRESS","TRICEPS DUMBBELL EXTENSIONS","FACE PULL","LEG PRESSE", "TRICEP PUSHDOWNS","WIDEPLANE DUMBBELL ROWS","SEATED LEG CURLS","HIP THRUSTES","GLUTE BRIDGES","HANGING LEG RAISES","HYPEREXTENSIONS"]
    ...
    var body: some View {
        ...
        ZStack {
            ...
            List(listOfExercises, id: \.self){ lol in
                Text(lol)
